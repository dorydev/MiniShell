...
This project will be a merge of MiniShell and LinuxFromScratch to create a simple, lightweight command-line OS. Written in C and Assembly, I built it from scratch to understand how a real operating system works.
